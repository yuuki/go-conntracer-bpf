...
static __always_inline void insert_tcp_flows(
    struct aggregated_flow_tuple* tuple, pid_t pid) {
...
static __always_inline void insert_udp_flows(
    pid_t pid, struct aggregated_flow_tuple* tuple) {
...
static __always_inline void update_message(struct aggregated_flow_tuple* tuple,
                                           size_t sent_bytes,
                                           size_t recv_bytes) {
